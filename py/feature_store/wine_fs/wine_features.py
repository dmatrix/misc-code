...
wine_features_table = FileSource(
    ...
    path="/Users/julesdamji/examples/py/feature_store/data/wine_features.parquet")

# Define an entity for the weather features. You can think of entity as a primary key used to
# fetch features.
acidity = Entity(name="volatile_acidity", value_type=ValueType.DOUBLE, description="acidity")
