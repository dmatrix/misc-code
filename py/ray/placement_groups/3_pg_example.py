...
if __name__ == "__main__":
    ...
    # It means Ray will reserve 2 "CPU" and 1 CPU on the same
    ...
    cpu_actors = [CPUActor.options(scheduling_strategy=PlacementGroupSchedulingStrategy(placement_group=pg,
    ...
    cpu_tasks = [extra_resource_task.options(scheduling_strategy=
                                             PlacementGroupSchedulingStrategy(placement_group=pg, 
                                             placement_group_bundle_index=1)).remote(2) for _ in range(2)]
